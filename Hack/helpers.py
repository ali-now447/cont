...
MENU1 = '''
𝗔 - تحقق من القنوات و المجوعات . (𝗣𝗨𝗕𝗟𝗜𝗖 𝗢𝗡𝗟𝗬)

𝗕 - سحب معلومات الحساب .

𝗖 - ازالة جميع من مجموعة معينهَ  .

𝗗 - تحويل آخر كود تسجيل دخول من تليگرام (استخدم A للحصول على رقم تسجيل دخول ( . 

𝗘 - دخول قناة او مجموعه . (من A)

𝗙 - مغادرة قناة او مجموعة . (من A)

𝗚 - حَذف قناة او مجموعه . (من A)

𝗛 - تحقق من لحساب يحتوي تحقق بخطوتين او للا .
'''

MENU2 = '''
𝗜 - انهاء جميع جلسات عدا جلسة تيرمكس. 

𝗝 - حذف الحساب .

𝗞 - مغادرة جميع القنوات و المجموعات .

𝗟 - اذاعه (للعام + للخاص + للكل ) .
    ...
    def dec(func):
        async def wrap(e):
            ...
            try:
                ...
                await e.reply('Some Error occur from bot side. Please report it to @mmmsc ')
